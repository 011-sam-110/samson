...
export const SCENARIOS = [
  {
    ...
    workings: [
      ['Available discretionary money', '£280 balance, nothing committed', 'available'],
      ['Days remaining', 'Aug 1 → Aug 15, today still spendable', 'daysRemaining'],
      ['Target daily spending pace', '£280 ÷ 14', 'targetDaily'],
      ['Days elapsed', 'today is day 1', 'daysElapsed'],
      ['Actual daily spending pace', '£15 ÷ 1', 'actualDaily'],
      ['Spending Pace Ratio', '£15 ÷ £20', 'ratio'],
    ],
...

  {
    ...
    workings: [
      ['Target daily spending pace', '£280 ÷ 14', 'targetDaily'],
      ['Actual daily spending pace', '£25 ÷ 1', 'actualDaily'],
      ['Spending Pace Ratio', '£25 ÷ £20', 'ratio'],
      ['Gauge', '1.25 is the top of the amber band', 'gauge'],
    ],
...

  {
    ...
    workings: [
      ['Period', 'payday to payday: Jul 29 → Aug 29', 'totalDays'],
      ['Days elapsed', 'Jul 29 → Aug 15, today included', 'daysElapsed'],
      ['Days remaining', 'Aug 15 → Aug 29', 'daysRemaining'],
      ['Commitments', 'rent £400 + phone £20 + subs £10', 'commitments'],
      ['Planned spends', 'birthday on the 18th', 'plannedSpends'],
      ['Available discretionary money', '£800 − £430 − £50', 'available'],
      ['Target daily spending pace', '£320 ÷ 14', 'targetDaily'],
      ['Discretionary spending so far', 'four logged spends', 'spentSoFar'],
      ['Actual daily spending pace', '£360 ÷ 18', 'actualDaily'],
      ['Spending Pace Ratio', '£20 ÷ £22.857 = 280 ÷ 320', 'ratio'],
      ['Spending room this week', '£320 × 7 ÷ 14', 'leftThisWeek'],
    ],
    expect: {
      ...
      ratio: 0.875, band: 'on-pace', leftThisWeek: 160, canSpend40: 0.875,
    },
  },

  {
    ...
    workings: [
      ['Available discretionary money', '£100 − £400', 'available'],
      ['Spending Pace Ratio', 'no ratio exists — there is no safe pace to be a fraction of', 'ratio'],
      ['Verdict shown', 'committed beyond the balance', 'band'],
    ],
...

  {
    ...
    workings: [
      ['Spending Pace Ratio', '£0 ÷ £35 — arithmetically zero', 'ratio'],
      ['Verdict shown', 'none: fewer than 3 of the last 7 days carry a spend', 'band'],
    ],
...
export const SAVING_SCENARIOS = [
  {
    ...
    workings: [
      ['Amount remaining', '£300 − £100', 'remaining'],
      ['Days remaining', 'Aug 10 → Sep 9', 'daysRemaining'],
      ['Required daily saving', '£200 ÷ 30', 'requiredDaily'],
      ['Amount actually saved', 'four £25 transfers', 'contributed'],
      ['Days elapsed', 'Aug 1 → Aug 10, today included', 'daysElapsed'],
      ['Actual saving pace', '£100 ÷ 10', 'actualDaily'],
      ['Saving Pace Ratio', '£10 ÷ £6.67', 'ratio'],
    ],
...

  {
    ...
    contributions: [],
    workings: [
      ['Progress shown on the goal bar', 'the £180 is real money and still counts', 'savedTotal'],
      ['Amount counted toward saving pace', 'none of it was saved in a window we watched', 'contributed'],
      ['Verdict shown', 'no transfers logged, so no verdict', 'band'],
    ],
...

  {
    ...
    workings: [
      ['Best streak', 'Aug 1 to Aug 6 — on Aug 7, £50 ÷ 7 days = £7.14 against £250 ÷ 33 = £7.58 required, so the pace is lost', 'bestStreak'],
      ['Current streak', 'four days behind pace', 'currentStreak'],
    ],
