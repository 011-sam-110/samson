...
// "Can I spend £X?" is a question you ask standing at the card reader, not a
// place you navigate to. It opens as a sheet over Today rather than owning a
// tab of its own: the answer only means anything next to the number it moves.

const CHIPS = [10, 20, 50, 100]

const HEADLINE = { yes: 'Go for it', tight: 'Cutting it fine', no: 'Better not' }

export default function CanISpend({ onDone }) {
  ...
  // Logging closes the sheet. Today is directly behind it, so the gauge dropping
  // is the confirmation - a "Logged ✓" tick would sit on top of the proof.
  const logIt = () => {
  ...
  return (
    <div style={{ textAlign: 'center' }}>
      <p className="sheet-lede">Type an amount. Leeway tells you the damage before you tap your card.</p>
